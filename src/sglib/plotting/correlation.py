"""
Correlation plotting functions for SGLib.
...
from sglib.core.statistics import compute_autocorrelation, compute_spatial_correlation
from sglib.plotting.config import COLORS, STYLE, LAYOUT, LABELS
from sglib.plotting._utils import (
