...
from sglib.core.base import Generator, Disaggregator
...
class GeneratorDisaggregatorPipeline:
    ...
    Examples
    --------
    >>> from sglib.methods.generate.nonparametric.kirsch import KirschGenerator
    >>> from sglib.methods.disaggregate.temporal.nowak import NowakDisaggregator
    >>> from sglib.core.pipeline import GeneratorDisaggregatorPipeline
    >>>
    >>> # Create components
