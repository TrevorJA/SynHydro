...
from sglib.core.statistics import compute_monthly_statistics, repair_correlation_matrix
...
class KirschGenerator(Generator):
    ...
    def _repair_and_cholesky(self, corr):
        ...
        Uses the centralized repair_correlation_matrix function from sglib.core.statistics.
